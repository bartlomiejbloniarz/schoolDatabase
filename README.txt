...
każdy ma dostęp do uczniów których uczy(również ich ocen okresowych oraz średnich ocen),
...
Część okienek pozwalających na dodawanie opraz aktualizację danych.
Zabezpieczenie aplikacji pod kątem haseł.
------------------------------------------------------------------------------------------------------
Inka Sokołowska:
Stworzone tabele:
...
Zabezpieczenia aplikacji po kątem regexów.
--------------------------------------------------------------------------------------------------------
...
Wkład pracy uznajemy jako równy oraz w większości kwestii wspólny.
