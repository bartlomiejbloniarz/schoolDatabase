...
drop function if exists koniec_roku(integer);
drop function if exists generuj_swiadectwo(integer, integer);
drop function if exists koniec_roku_czyszczenie(integer);
drop function if exists niezdajacy_uczniowie(integer);
drop function if exists przedmiot(integer);
drop function if exists przedmiot(varchar);
drop function if exists koniec_roku_braki(integer);
