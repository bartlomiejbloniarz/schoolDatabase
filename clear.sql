...
drop function terminarz_klasy(integer);
drop function swiadectwa_srednie(integer);
drop function koniec_roku(integer);
drop function generuj_swiadectwo(integer, integer);
drop function koniec_roku_czyszczenie(integer);
